...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 21 Bulan Mei 2026 pada 14.52
...
(1, 'Integrasi AI', 'brain', 'Implementasi kecerdasan buatan tingkat lanjut untuk mengotomatisasi kompleksitas dan meningkatkan efisiensi operasional bisnis Anda dengan teknologi machine learning terkini.', 1, '2026-04-24 03:15:50', '2026-04-24 03:15:50'),
(2, 'Cloud Nexus', 'cloud', 'Arsitektur cloud masa depan yang skalabel, aman, dan dirancang khusus untuk performa tinggi tanpa batas. Migrasi, optimasi, dan manajemen infrastruktur cloud enterprise.', 2, '2026-04-24 03:15:50', '2026-04-24 03:15:50'),
(3, 'Cyber Fortress', 'shield', 'Sistem keamanan siber mutakhir dengan perlindungan proaktif 24/7 yang menjaga aset digital Anda dari ancaman tercanggih menggunakan AI-driven threat intelligence.', 3, '2026-04-24 03:15:50', '2026-04-24 03:15:50'),
(4, 'Custom Software', 'layers', 'Pengembangan aplikasi web dan mobile yang disesuaikan penuh dengan kebutuhan bisnis Anda — dari ideasi hingga deployment production.', 4, '2026-04-24 03:15:50', '2026-04-24 03:15:50'),
(5, 'Data Analytics', 'bar-chart', 'Transformasi data mentah menjadi insight bisnis yang actionable melalui dashboard real-time, predictive analytics, dan laporan interaktif berbasis BI tools modern.', 5, '2026-04-24 03:15:50', '2026-04-24 03:15:50'),
(6, 'DevOps & CI/CD', 'git-merge', 'Automasi pipeline delivery, containerisasi (Docker/Kubernetes), dan kultur DevOps yang mempercepat time-to-market hingga 10x lebih cepat.', 6, '2026-04-24 03:15:50', '2026-04-24 03:15:50');
...
(1, 'admin', '$2b$10$AYEh3JcdZRr76lMBa3jyVOp7ljwlJRiS205Hs.3vNVKXqsxCrlUrq', 'admin', '2026-04-24 03:15:50');
